...
from interval_discrimination import IntervalDisc1D
import json
...
def parse_argument():
    ...
    parser.add_argument('--core', type=str, default='cogrnn', choices=['rnn', 'lstm', 'cogrnn'], help='core type to use')
...
if __name__ == "__main__":
    ...
    env_configs = {
        ...
        'stimuli': [tuple(stim_pair) for stim_pair in config_json['env_stimuli']],
        'scale': parsed_args.env_scale,
        'timings': {
            'fixation': config_json['env_timings_fixation'],
            'delay1': config_json['env_timings_delay1'],
            'delay2': config_json['env_timings_delay2'],
    ...
    env = IntervalDisc1D(**env_configs)
